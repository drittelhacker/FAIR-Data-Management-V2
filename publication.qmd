...
::: callout-note
## Excursion: Software licenses and Copyleft

Navigating the jungle of software licenses is not an easy task. Several things are to be considered, e.g., whether you want to allow commercial use of your software, whether you want to allow modifications and derivative works, whether you want to impose the same license on derivative works (so-called "copyleft"), etc. Also, compatibility of licenses is an important aspect to consider when combining code from different sources. A good starting point is to distinguish between permissive licenses (e.g., MIT, Apache) and copyleft licenses (e.g., GNU GPL). Permissive licenses allow you to do almost anything with the code as long as you provide attribution, while copyleft licenses require that any derivative works also be distributed under the same license terms.

As a rule of thumb, if you want to maximize the reuse potential of your software (and thus the likelyhood of citations), you should go with a permissive license. If you want to ensure that any derivative works also remain open, you might consider a copyleft license. However, be aware that copyleft licenses can limit the reuse of your software in certain contexts, especially if they are not compatible with other licenses.

For an introduction on the interplay of licenses see, e.g., [https://dwheeler.com/essays/floss-license-slide.html](https://dwheeler.com/essays/floss-license-slide.html).

To understan copyright vs. copyleft and GNU's GPL visit [https://opensource.com/resources/what-is-copyleft](https://opensource.com/resources/what-is-copyleft). 

For some guidance in the selection process check [https://choosealicense.com/](https://choosealicense.com/) and to understand open source software licenses summarized in layman's terms take a look at [https://www.tldrlegal.com/](https://www.tldrlegal.com/).

Another rule of thumb is to check which licenses are commonly used in your research field and go with one of those. This will make it easier for others to understand the conditions under which they can reuse your software and thus increase the likelihood of reuse. You should also try to stick with [established and widely used licenses](https://opensource.org/licenses?categories=popular-strong-community), as these are more likely to be recognized and understood by other researchers.

If you get lost in the jungle of software licenses, the legal department of the MP headquarters is available for advice as well.
:::
