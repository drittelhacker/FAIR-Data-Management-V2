...
Instructions on how to install the software and get it running. This can include prerequisites, dependencies, and step-by-step installation instructions.

\## Usage

Instructions on how to use the software, including examples of common use cases and command-line options. This section can also include information on how to run tests, if applicable. For a paper code repository, you can also include instructions on how to reproduce the results of the paper.

\## Contributing

If applicable add this section with guidelines for contributing to the project, including how to report issues, submit pull requests, and any coding standards or best practices that should be followed. 

\## License

License information for the software. This should include the name of the license and a link to the full license text. If your project includes code from other sources, you should also include information about the licenses for those dependencies and ideally link their full license texts, as well.

\## Citation

Instructions on how to cite the software in academic publications. This can include a recommended citation format and any relevant identifiers (e.g., DOI, GitHub repository URL).
